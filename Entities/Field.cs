...
namespace BS.Common.Entities
{
    ...
    public class Field
    {
        ...
        /// <summary>
        /// Specifies whether the column is included in SQL INSERT statements generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>, defaults to true.
        /// </summary>
        public bool Insertable { get; set; }

        /// <summary>
        /// Specifies whether the column is included in SQL UPDATE statements generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>, defaults to true.
        /// </summary>
        public bool Updatable { get; set; }
        
        /// <summary>
        /// Specifies that the Entity will be join with another table using this field. This is only used in SQL SELECT statements  generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>, defaults to null.
        /// </summary>
        ...
        /// </summary>
        /// <param name="name">The name of the column.</param>
        /// <param name="insertable">Specifies whether the column is included in SQL INSERT statements generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>.</param>
        /// <param name="updatable">Specifies whether the column is included in SQL UPDATE statements generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>.</param>
        ...
        /// <param name="defaultVal">Overrides the value of a field if it's specified, for example if you want to default the value of a date field to GETDATE()</param>
        /// <param name="dataType">Specifies the field data type</param>
        /// <param name="insertable">Specifies whether the column is included in SQL INSERT statements generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>, defaults to true.</param>
        ...
        /// <param name="dataType">Specifies the field data type</param>
        /// <param name="insertable">Specifies whether the column is included in SQL INSERT statements generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>, defaults to true.</param>
        /// <param name="updatable">Specifies whether the column is included in SQL UPDATE statements generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>, defaults to true.</param>
        ...
        /// <param name="insertable">Specifies whether the column is included in SQL INSERT statements generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>, defaults to true.</param>
        /// <param name="updatable">Specifies whether the column is included in SQL UPDATE statements generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>, defaults to true.</param>
        /// <param name="foreignKey">Specifies that the Entity will be join with another table using this field. This is only used in SQL SELECT statements  generated by the <see cref="T:BS.Common.Utils.QueryBuilder"/>, defaults to null.</param>
